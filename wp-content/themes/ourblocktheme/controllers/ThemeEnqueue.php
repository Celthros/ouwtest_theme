...
class ThemeEnqueue {
	...
	private static string $googleMapApiKey = "AIzaSyBRRnSwouBfAyhQ47rfDX0NMPcqiQ1Qm4s";

	public function __construct() {
		self::load_dependencies();
		add_action( 'wp_enqueue_scripts', [ self::class, 'theme_Enqueues' ] );
		add_filter( 'login_enqueue_scripts', [ self::class, 'ourLoginCSS' ] );
		add_filter( 'acf/fields/google_map/api', [ self::class, 'campusMapKey' ] );
	}

	public static function theme_Enqueues(): void {
