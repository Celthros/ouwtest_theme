...
class HeroSlider {
  constructor() {
    ...
    allSlideshows.forEach(currentSlideshow => {
      const slides = currentSlideshow.querySelectorAll(".hero-slider__slide");
      if (!slides.length) {
      ...
      const bulletsContainer = currentSlideshow.querySelector(".glide__bullets");
      if (!bulletsContainer) {
        console.error("Bullets container not found in the current slideshow.");
        return;
      }
      bulletsContainer.insertAdjacentHTML("beforeend", dotHTML);
      const glide = new _glidejs_glide__WEBPACK_IMPORTED_MODULE_0__["default"](currentSlideshow, {
        type: "carousel",
        perView: 1,
        autoplay: 3000
      });
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = globalThis["webpackChunkourblocktheme"] = globalThis["webpackChunkourblocktheme"] || [];
